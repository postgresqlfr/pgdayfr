...
<div style="width: 100%;">
  ...
  <div class="row" style="display: flex; flex-wrap: wrap;">
    ...
    <!-- Accueil 2027 / Host City -->
    <div class="col-md-12" style="margin-bottom: 20px;">
      <div class="well" style="border-top: 8px solid #337ab7; padding: 30px; text-align: center; background-color: #f7fafd;">
        <h2 style="color: #337ab7; margin-top: 0;"><i class="fa fa-map-marker"></i> Organisation 2027 : Proposez votre ville !</h2>
        <p class="lead" style="margin: 15px 0;">
          L'appel à candidature pour l'organisation du PG Day France 2027 est ouvert jusqu'au 15 novembre 2026.
        </p>
        <p>
